        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">₽<span class="caret"></span></a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                    <li class="dropdown-item"><a class="dropdown-item" href="#">₽</a></li>
                                                    <li class="dropdown-item"><a class="dropdown-item" href="http://internet-shop.tmweb.ru/currency/USD">$</a></li>
                                                    <li class="dropdown-item"><a class="dropdown-item" href="http://internet-shop.tmweb.ru/currency/EUR">€</a></li>
                                            </ul>
                </li>
            </ul>
